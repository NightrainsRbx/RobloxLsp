...
SharedTable.new = 'Returns a new, empty SharedTable.'
SharedTable.clear = 'Automically removes all of the elements from a SharedTable.\n\nIf the SharedTable is frozen, the operation fails and an error will be raised.'
SharedTable.clone = 'Creates a clone of a SharedTable and returns the clone.'
SharedTable.cloneAndFreeze = 'Creates a frozen (read-only) clone of a SharedTable and returns the clone.'
SharedTable.increment = 'Atomically increments the value of an element.'
SharedTable.isFrozen = 'Returns true if the SharedTable is frozen (read-only).'
SharedTable.size = 'Returns the number of elements stored in the SharedTable.'
SharedTable.update = 'Atomically updates the value of an element.'
