...
function openUpdatesWindow(context) {
    return __awaiter(this, void 0, void 0, function* () {
        if (context.globalState.get("sawVersionLog1", false) == false) {
            const panel = vscode.window.createWebviewPanel('robloxlspUpdates', // Identifies the type of the webview. Used internally
...
<<<<<<< HEAD
            ...
            yield context.globalState.update("sawVersionLog1", true);
=======
            ...
            yield context.globalState.update("sawVersionLogNew2", true);
>>>>>>> origin/master
        }
    });
}
